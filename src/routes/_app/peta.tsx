...
const PROVINCES: { name: string; x: number; y: number }[] = [
  { name: "Aceh", x: 5, y: 16 },
  { name: "Sumatra Utara", x: 7, y: 27 },
  { name: "Riau", x: 12, y: 23 },
  { name: "Kepulauan Riau", x: 17, y: 24 },
  { name: "Sumatra Barat", x: 9, y: 37 },
  { name: "Jambi", x: 13, y: 40 },
  { name: "Bengkulu", x: 10, y: 48 },
  { name: "Sumatra Selatan", x: 14, y: 50 },
  { name: "Kepulauan Bangka Belitung", x: 19, y: 42 },
  { name: "Lampung", x: 16, y: 58 },
  { name: "Banten", x: 19, y: 67 },
  { name: "Jakarta", x: 22, y: 64 },
  { name: "Jawa Barat", x: 24, y: 72 },
  { name: "Jawa Tengah", x: 28, y: 72 },
  { name: "Yogyakarta", x: 30, y: 78 },
  { name: "Jawa Timur", x: 33, y: 74 },
  { name: "Bali", x: 38, y: 77 },
  { name: "Nusa Tenggara Barat", x: 42, y: 80 },
  { name: "Nusa Tenggara Timur", x: 47, y: 84 },
  { name: "Kalimantan Barat", x: 28, y: 32 },
  { name: "Kalimantan Tengah", x: 33, y: 47 },
  { name: "Kalimantan Selatan", x: 37, y: 52 },
  { name: "Kalimantan Timur", x: 40, y: 33 },
  { name: "Kalimantan Utara", x: 42, y: 22 },
  { name: "Sulawesi Utara", x: 55, y: 25 },
  { name: "Gorontalo", x: 52, y: 33 },
  { name: "Sulawesi Tengah", x: 52, y: 41 },
  { name: "Sulawesi Barat", x: 50, y: 51 },
  { name: "Sulawesi Selatan", x: 52, y: 60 },
  { name: "Sulawesi Tenggara", x: 57, y: 51 },
  { name: "Maluku Utara", x: 67, y: 25 },
  { name: "Maluku", x: 70, y: 51 },
  { name: "Papua Barat Daya", x: 75, y: 35 },
  { name: "Papua Barat", x: 80, y: 38 },
  { name: "Papua Tengah", x: 85, y: 56 },
  { name: "Papua Pegunungan", x: 88, y: 41 },
  { name: "Papua", x: 92, y: 38 },
  { name: "Papua Selatan", x: 90, y: 66 },
];
